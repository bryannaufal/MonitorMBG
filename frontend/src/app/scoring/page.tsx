  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
        <section className="overflow-hidden rounded-xl border border-border bg-surface-raised xl:col-span-2">
              ...
              {scores.map((score) => (
                <tr key={score.id} onClick={() => setSelected(score)} className="cursor-pointer border-b border-border hover:bg-surface">
                  <td className="px-4 py-4">
                    <p className="font-medium">{score.vendor_name}</p>
          ...
          {selected ? (
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">{selected.recommended_action}</p>
              </div>

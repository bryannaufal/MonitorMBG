  ...
  return (
    <div className="flex min-h-full flex-col space-y-6">
      <PageHeader
        ...
        description="Contextual assistant for case synthesis, evidence explanation, vendor history, scoring rationale, and recommended next action."
        breadcrumbs={[{ label: "Command Center", href: "/" }, { label: "AI Case Copilot" }]}
        source={source}
        error={error}
      />

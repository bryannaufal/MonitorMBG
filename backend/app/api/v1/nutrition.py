...
async def get_nutrition_results(report_id: int):
    ...
    return {
        ...
        "portion_adequacy": "Needs Review" if score and score["nutrition_concern_score"] >= 70 else "Adequate",
        "nutrition_concern_score": score["nutrition_concern_score"] if score else 0,
